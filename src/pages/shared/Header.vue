    ...
    >
      ...
      <div class="hidden lg:flex lg:gap-x-12 link-parent">
        <a
          ...
          @click="scrollElementIntoView('.resume')"
          v-if="personalPage"
        >
          Resume
        </a>
        <a
          class="text-sm font-semibold leading-6 text-gray-900"
          @click="scrollElementIntoView('.professional-projects')"
          v-if="personalPage"
        >
          ...
          <div class="-my-6 divide-y divide-gray-500/10">
            <div class="space-y-2 py-6">
              ...
              <a
                @click="
                  mobileMenuOpen = false;
                  scrollElementIntoView('.professional-projects');
                "
                class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50"
                v-if="personalPage"
              >
...
.header-light {
  ...
  border-bottom: 2px solid rgba(234, 125, 28, 0.35);
}
</style>

...
const date = ref(new Date("2024/01/17"));
...
const tourSteps = ref([
	{
		...
		content: `Welcome to the Food Tracker! This is an application meant to track the users meals. Here you can see a calendar of some recent days.`,
		params: {
			placement: "top",
		},
	},
	{
		...
		content: `Here you can change the active date you are looking at. It will automatically show the entire week of the date you selected.`,
		params: {
			placement: "top",
		},
	},
	{
		...
		content: `Here you can add some new meals to your calendar.`,
		params: {
			placement: "top",
		},
	},
	{
		...
		content: `Assuming you've never used this application before, this Calendar is likely very empty right now. Go ahead and hit the "Add New Meal" button to get started!`,
		params: {
			placement: "top",
		},
	},
...
function startTour() {
	tours.value.foodTrackerTour.start();
}
